# WorldForge launcher - rebuilds from source then launches Electron, auto-closes console.
$ErrorActionPreference = 'Stop'
$here = $PSScriptRoot
Write-Host "[worldforge] rebuilding from source..." -ForegroundColor Yellow
npm install --silent --prefix $here | Out-Null
Write-Host "[worldforge] launching Electron..." -ForegroundColor Yellow
